...
<div id="art" class-"page gallery">
  ...
  <div id="content" class="clear">
    ...
    <h3><strong>Focus</strong> (Religion as barrier)</h3>
    ...
    <h3><strong>Macro</strong> (Life in the details)</h3>
    ...
    <ul>
      ...
      <li><img src="/img/fineart/macro-3.jpg" alt="Circular photo of a succulent plant (unknown species) taken at the Garfield Park Conservatory in Chicago, Illinois." /></li>    
    </ul>
  
    <h3><strong>Persephone's Garden</strong> (How did she pass the time?)</h3>
    <h4>Chicago, Illinois</h4>
		<ul>
